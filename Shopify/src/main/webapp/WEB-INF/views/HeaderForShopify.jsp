...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath}/test"><i class="fas fa-shopping-cart"></i>Shopify</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <c:if test="${pageContext.request.userPrincipal.name!=null}"><li><a href="viewProfile/${pageContext.request.userPrincipal.name}">Hello ${pageContext.request.userPrincipal.name}</a></li></c:if>
...
<li><a href="${pageContext.request.contextPath}/DisplayUser">User-List</a></li>
</security:authorize>
